...
export const SideBar: FC<ISideBarProps> = ({
  ...
  return (
    <nav style={menuVision ? menuStyleSetting : {}} className={styles.sideBar}>
        ...
        {menuList.map((item: IMenuItem) => {
          return (
            <li
              className={
                activeItem === item.id
                  ? classNames(styles.menuItem, styles.menuItemActive)
                  : styles.menuItem
              }
              onClick={() => {
                itemHandler(item.id);
        ...
        <div
          className={
            theme === 'light'
              ...
              : classNames(styles.themeSwitcher, styles.anotherSwitcher)
          }
        >
          <div
            className={classNames(
              styles.variant,
              theme === 'light' ? styles.variantActiveLight : ''
            )}
          ...
          <div
            className={classNames(
              styles.variant,
              theme === 'dark' ? styles.variantActiveDark : ''
            )}
            onClick={themeHandler}
          >
