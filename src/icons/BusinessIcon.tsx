...
export const BusinessIcon: FC<IIconProps> = ({ width = 30, height = 28}) => {
  return (
    <svg
      width={width}
      height={height}
      ...
      <defs>
        <linearGradient id="paint0_linear_1_1220" x1="31.3866" y1="-2.61536" x2="-1.59884" y2="-0.748413" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5970E0"/>
          <stop offset="1" stopColor="#462EDF"/>
        </linearGradient>
        <linearGradient id="paint1_linear_1_1220" x1="29.8969" y1="-2.61536" x2="-0.106481" y2="-1.07157" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5970E0"/>
          <stop offset="1" stopColor="#1C37B8"/>
        </linearGradient>
      </defs>
    </svg>
